...
module.exports = {
  name: "ha6781bs78xz7wdnw8w22zq",
  description: "Manjua ChangeLog",
  usage: "",
  permissions: {
  ...
  run: async (client, message, args, { GuildDB }) => {
    let embed = new MessageEmbed()
      .setAuthor(
        "Manjua Candis Discord Bot Oficial Changelog",
        client.user.displayAvatarURL()
      )
      .setColor("#db0f00")
      .setDescription(
        `Check the lastest updates [here](https://www.youtube.com/watch?v=dQw4w9WgXcQ)`
      );
